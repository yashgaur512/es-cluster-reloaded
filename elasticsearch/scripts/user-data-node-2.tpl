...
echo "node.name: ${environment}-common-es-node-2" >> /etc/elasticsearch/elasticsearch.yml
echo "discovery.seed_hosts: [\"127.0.0.1\",\"${es_node_0_ip}\",\"${es_node_1_ip}\"]" >> /etc/elasticsearch/elasticsearch.yml
